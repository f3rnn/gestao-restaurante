...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PratoJaExistenteException.class)
    public ResponseEntity<Map<String, Object>> handlerPratoJaExistenteException (PratoJaExistenteException erro) {
